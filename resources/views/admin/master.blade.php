...
<head>
    ...
    <title>Project With Laravel Admin Theme</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{url('/dashboard')}}">Project With Laravel</a>
            </div>
    ...
    <script src="{{asset('public/admin/')}}/tiynemce/jquery.tinymce.min.js"></script>
